...
def main(seq_name, motion_dir):
    ...
    features = extract_group_kinetic_features(all_keypoints3d) #extract feats for the whole group, (72,)

    print(features.shape);
    np.save(os.path.join(args.save_dir, seq_name + "_group_kinetic.npy"), features)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='./datasets/gdance/eval_group_features/',
