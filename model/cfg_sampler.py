...
class ClassifierFreeSampleModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None):
        ...
        out = self.model(x, timesteps, y) #shape (bs, npersons, seq_len, nfeats)
        out_uncond = self.model(x, timesteps, y_uncond) # perform unconditioning by setting the cond (enc_text) to zeros
